...
class UkmTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('ukms')->insert([
            ...
            'jam' => "",
            'tempat' => "",
            'profil' => "Pramuka Unpad resmi didirikan pada 30 Agustus 1975. Pramuka Unpad membentuk karakter anggotanya  untuk  siap terjun ke masyarakat. Kegiatan yang dilaksanakan oleh Pramuka Unpad berada di ruang lingkup pengembangan keterampilan anggota berwawasan lingkungan, bakti kepada masyarakat, kegiatan alam bebas, seni dan budaya, kewirausahaan, serta kegiatan lain yang menunjang pengembangan anggota Ambalan-Racana Padjadjaran. Beberapa contoh kegiatan yang dilakukan oleh Pramuka Unpad diantaranya Hiking Bersama Berorientasi Alam (Hiberbola), Lomba Baris Berbaris Padjadjaran yang saat ini telah memasuki penyelanggaraan ke-5 dan menjadi event 2 tahunan, upgrading anggota, repling dan kegiatan lain yang menunjang tujuan dari Pramuka Unpad dalam pengembangan anggota. Untuk di lingkup universitas, kegiatan rutin yaitu menjadi petugas pengibar bendera pada upacara hari Pendidikan Nasional dan hari Kemerdekaan Republik Indonesia. Selain melakukan kegiatan rutin, Pramuka Unpad juga turut serta mendelegasikan anggota dalam kegiatan Pramuka yang diadakan oleh perguruan tinggi lainnya baik dalam lingkup regional, nasional maupun internasional.",
            'ketua' => "Pandu Budiman",
            'npm' => "200110170047",
            'pembina' => "FMIPA",
        ]);   
